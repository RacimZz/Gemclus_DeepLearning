...
Ce dépôt présente une exploration approfondie de l’algorithme **GEMINI** (Generalised Mutual Information for Discriminative Clustering) appliqué à des données spectrales d’astronomie, en complément de l’approche classique FisherEM.  
...
- **GEMINI (MMD)** a tendance à créer des groupes assez **uniformes** (clusters “sphériques”), similaires à ceux de **k-means**, ce qui peut limiter la détection de structures plus complexes, comme on peut l'apercevoir ci dessous avec les silhouette score des classes.
<p align="center">
...
- **L’introduction de la distance Wasserstein** dans GEMINI devrait permettre de dépasser la limitation des formes sphériques : elle prend en compte la forme globale des distributions, et facilite l’identification de groupes complexes ou “allongés”.
...
> ces `.json(l)` permettent de sauvegarder en continue les classifications, et par conséquent d'analyser et de visualiser les résultats
